 ...
 *     table_prefix?: scalar|Param|null, // Doctrine table prefix (REQ-ORM-002). Final table: {prefix}_variables. // Default: "runtime_env"
 *     database?: array{
 *         entity_manager?: scalar|Param|null, // Doctrine ORM entity manager name. // Default: "default"
 *     },
 *     panel?: array{ // Admin CRUD panel.
 *         enabled?: bool|Param, // Default: true
 *         path_prefix?: scalar|Param|null, // URL prefix for manage routes. // Default: "/_runtime_env"
 *     },
 *     web_ui?: array{ // REQ-UI-001 look-and-feel.
 *         enabled?: bool|Param, // Default: true
 *         layout_template?: scalar|Param|null, // Default: "@NowoRuntimeEnvBundle/manage/layout.html.twig"
 ...
 *     },
 *     security?: array{ // REQ-UI-002 roles + optional access checker.
 *         access_roles?: list<scalar|Param|null>,
 *         access_checker?: scalar|Param|null, // Optional service id implementing RuntimeEnvAccessCheckerInterface. null = role-based default. // Default: null
 *         allow_unauthenticated?: bool|Param, // DEV/DEMO only. Never true in production. // Default: false
 *     },
 *     templates?: array{
 *         index?: scalar|Param|null, // Default: "@NowoRuntimeEnvBundle/manage/index.html.twig"
 *         form?: scalar|Param|null, // Default: "@NowoRuntimeEnvBundle/manage/form.html.twig"
 *         layout?: scalar|Param|null, // Default: "@NowoRuntimeEnvBundle/manage/layout.html.twig"
 *     },
 * }
 ...
 *     nowo_runtime_env?: NowoRuntimeEnvConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
